                    ...
                    {employees.map((employee) => (
                        <div key={employee.id}>
                            <img
                                ...
                                aria-hidden alt="# Image not Uploaded"
                            />
                    ...
                    {gmemployees.map((employee) => (
                        <div key={employee.id}>
                            <img
                                src={employee.employeeImg}
                                className="h-56 w-auto rounded-full mb-2 mx-auto"
                                aria-hidden alt="# Image not taken"
                            />
            ...
            <div className=" " >
                <div className="flex flex-col lg:flex-row   justify-around items-center text-center  mt-10 gap-5 lg:gap-0">
                    ...
                    {itemployees.map((employee) => (
                        <div key={employee.id}>
                            <img
                                ...
                                aria-hidden alt="# Image not taken"
                            />
                            <a href="https://github.com/YEL-59"><div className="mt-10 bg-blue-900 bg-opacity-80 p-3 rounded text-white px-12">
                                <h1 className=" text-2xl  font-bold uppercase">
                                    {employee.employeeName}
                                </h1>
                                <p className="">{employee.employeeDesi}</p>
                    ...
                    <div className="  ">
                            ...
                            {devemployees.map((employee) => (
                                <a href="https://github.com/YEL-59"><div key={employee.id}>
                                    <img
                                        src={employee.employeeImg}
                                        className="h-56 w-auto rounded-full mb-2 mx-auto"
                                        aria-hidden alt="# Image not taken"
