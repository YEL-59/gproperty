...
function Blog() {
    return (
        <div>
            <div className="container mx-auto flex lg:flex-row flex-col justify-between items-center gap-9 mt-10">

                <div>
                    <div >
                        <div class=" w-full rounded-lg lg:shadow-lg bg-white mb-6 p-2 lg:p-0">
